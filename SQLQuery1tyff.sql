...
VALUES('jaiswalsamarth02@gmail.com','password','CHILD');
...
INSERT INTO VAC(VAC_NO,NAME,STATUS,CHILD_ID)
...
VALUES('RAVIKUMAR','SRISTI',123456,60010013,'jaiswalsamarth02@gmail.com','g-134firstfloor jhilmil',644598077892);
delete from detail;
select DETAIL.EMAIL_ID,DATEDAY from DETAIL,CHILD where CHILD.CHILD_ID=DETAIL.CHILD_ID and CHILD.CHILD_ID=123456;
